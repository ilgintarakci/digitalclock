...
lb_hr = Label(clk,text = "12" , font = ("Times 20 bold",75, "bold"),bg ="black",fg ="white")
...
lb_mn = Label(clk,text = "12" , font = ("Times 20 bold",75, "bold"),bg ="black",fg ="white")
...
lb_sc = Label(clk,text = "12" , font = ("Times 20 bold",75, "bold"),bg ="black",fg ="white")
lb_sc.place(x=690,y=200,width =150 , height =150)

lb_sc_txt = Label(clk, text = "SECOND",font =("Times 20 bold",20, "bold"),bg = "black",fg = "white")
lb_sc_txt.place(x=690 , y = 360 , width = 150 , height = 50)

lb_dn = Label(clk,text = "AM" , font = ("Times 20 bold",75, "bold"),bg ="yellow",fg ="black")
lb_dn.place(x=860,y=200,width =150 , height =150)

lb_dn_txt = Label(clk, text = "NOON",font =("Times 20 bold",20, "bold"),bg = "yellow",fg = "black")
